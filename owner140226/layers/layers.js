...
lyr__2.set('fieldAliases', {'fid': 'fid', 'Name': 'Name', 'сельс': 'сельс', 'work': 'work', 'заход': 'заход', 'площа': 'площа', });
...
lyr__2.set('fieldImages', {'fid': '', 'Name': '', 'сельс': '', 'work': '', 'заход': '', 'площа': '', });
...
lyr__2.set('fieldLabels', {'fid': 'no label', 'Name': 'no label', 'сельс': 'no label', 'work': 'no label', 'заход': 'no label', 'площа': 'no label', });
